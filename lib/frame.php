...
<head>
    ...
    <meta itemprop="url" content="<?php echo "{$config['protocol']}{$config['domain']}{$config['path']}";?>" />
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <div class="form-inline" onkeyup="enterJudge(event)">
                            <div class="input-group">
                                ...
                                <input name="keyword" autocomplete="off" id="keyword" class="form-control" title="输入任意字母以进入隐私模式" required="required" tabindex="10" placeholder="索引或隐私串"/>
        ...
        <div class="row">
            ...
            <div class="col-md-8" style="display:none;margin-top: 1.375em; margin-bottom: 1.375em;" id="success_div">
                ...
                <div class="jumbotron">
                    ...
                    <ul>
                        <li>在主页中输入索引</li>
                        <li>在浏览器中访问：<a id="url" v-bind:href="'<?php echo $base_url?>' + keyword"><?php echo $base_url?>{{ keyword }}</a> <a tabindex="1" id="copy" href="#" base="<?php echo $base_url?>">复制链接</a></li>
